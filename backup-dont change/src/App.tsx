...
export default function App() {
  ...
  const model = useMemo(
    () => snapshot ? buildGraphModel(snapshot, { query, pods, roles, planes, expandedClusters, selectedNodeIds: selection.nodeIds, gpuSourceNodeIds: gpuSourceIds, visibleGpuPods }) : undefined,
    [expandedClusters, gpuSourceIds, planes, pods, query, roles, selection.nodeIds, snapshot, visibleGpuPods],
  );
